...
* EIGRP 
  * MD5 based 
    * Classic mode, interface config 
      * IPv4 `R(config-if)# ip authentication mode eigrp 100 md5` and `R# ip authentication key-chain eigrp 100 KEY-CHAIN-NAME`
      * IPv6 `R(config-if)# ipv6 authentication mode eigrp 100 md5` and `R# ipv6 authentication key-chain eigrp 100 KEY-CHAIN-NAME`
