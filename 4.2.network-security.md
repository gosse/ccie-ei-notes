...
* 4.2.b iii Unicast Reverse Path Forwarding
  ...
  * `ip verify unicast source reachable-via rx`
    * This will not allow the default route to pass the RPF check
    * `ip verify unicast source reachable-via rx allow-default`
  * `ipv6 verify unicast source reachable-via rx`


#### 4.2.c IPv6 infrastructure security features
* Protip: wifhen you configure IPv4 and IPv6 source guard on the same interface, use `ip verify source mac-check` no `ip verify source`
